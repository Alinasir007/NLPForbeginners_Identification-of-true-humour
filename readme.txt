...
There are a few additional packages we'll be using during the project- wordcloud, textblob and gensim.

Tip: vist NLTK documentation before downloading the package.
